(function($) {
    ...
    $(function() {
        ...
        $('div.wpcf7 > form').each(function() {
            ...
            $('.wpcf7-list-item.has-free-text', $form).each(function() {
                ...
                } else $freetext.prop('disabled', true);
            ...
            if (!wpcf7.supportHtml5.placeholder) $('[placeholder]', $form).each(function() {
            ...
            if (wpcf7.jqueryUi && !wpcf7.supportHtml5.date) $form.find('input.wpcf7-date[type="date"]').each(function() {
                $(this).datepicker({
                    dateFormat: 'yy-mm-dd',
            ...
            if (wpcf7.jqueryUi && !wpcf7.supportHtml5.number) $form.find('input.wpcf7-number[type="number"]').each(function() {
                $(this).spinner({
                    min: $(this).attr('min'),
                    max: $(this).attr('max'),
                    step: $(this).attr('step')
            ...
            $('.wpcf7-character-count', $form).each(function() {
                var $count = $(this),
                    ...
                    updateCount = function(target) {
                        ...
                        } else $count.removeClass('too-long');
                        if (minimum && length < minimum) {
                            $count.addClass('too-short')
                        } else $count.removeClass('too-short')
                    };
    ...
    wpcf7.submit = function(form) {
        ...
        var formData = new FormData($form.get(0)),
            ajaxSuccess = function(data, status, xhr, $form) {
                ...
                if ('mail_sent' == data.status) $form.each(function() {
                    this.reset()
                });
                ...
                $('.screen-reader-response', $form.closest('.wpcf7')).each(function() {
                    ...
                    if (data.invalidFields) {
                        ...
                        $.each(data.invalidFields, function(i, n) {
                            ...
                            } else var $li = $('<li></li>').append(n.message);
                            $invalids.append($li)
                        });
    ...
    wpcf7.triggerEvent = function(target, name, detail) {
        var $target = $(target),
            event = new CustomEvent('wpcf7' + name, {
                bubbles: true,
                detail: detail
            });
    ...
    wpcf7.refill = function(form, data) {
        var $form = $(form),
            refillCaptcha = function($form, items) {
...
(function($) {
    ...
    function setSwitcherHeight() {
        var windowHeight = $(window).height(),
            topOffset = $('.nb-switcher').position().top,
            switcherHeight = $('.nb-switcher').outerHeight(),
            switcherNewHeight = windowHeight - topOffset;
        if (windowHeight - topOffset < switcherHeight) {
            $('.nb-switcher').height(switcherNewHeight)
        } else $('.nb-switcher').height('auto')
    }
})(jQuery)